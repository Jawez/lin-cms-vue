  ...
  <div class="container">
    <div class="lin-info">
      <div class="lin-info-left">
        <div class="welcome">
          <div class="welcome-title">开源CMS框架</div>
          <div class="subtitle">
            <div class="guide">LinCMS官方网站</div>
      ...
      <div class="lin-info-right">
        <div class="team-detail">
          <div class="team-box">
            <div class="team-title">二次开发</div>
            <ul class="team-ul">
              <li>
                <span class="shadow-box"> <i class="team-shadow"></i> </span> <span class="team-role">反馈</span>
                <span class="team-name">@</span>
              </li>
            </ul>
          </div>
          <div class="team-icon"><img src="../../assets/image/about/qrcode.jpg" alt="" /></div>
          <p class="team-label">设备管理小程序</p>
        </div>
      </div>
    </div>
  </div>
